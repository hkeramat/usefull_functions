...
from shapes_utils_1 import Shape_1
...
class ShapeMain:
    ...
    def mesh(self, *args, **kwargs):
        ...
        with pygmsh.geo.Geometry() as geom:
            ...
            shape_0 = Shape()
            shape_1 = Shape_1()
            shape_0.read_csv('0.csv')
            shape_1.read_csv('1.csv')
            self.curve_pts_0 = shape_0.generate(ccws=True)
            self.curve_pts_1 = shape_1.generate(ccws=True)
            poly      = geom.add_polygon(self.curve_pts,
                                         make_surface=not mesh_domain)
            poly_0      = geom.add_polygon(self.curve_pts_0,
                                         make_surface=not mesh_domain)
            ...
            if (mesh_domain):
                ...
                holes.append(poly_0.curve_loop)
...
# Generate shape
shape_1 = ShapeMain()
shape_1.read_csv('2.csv')
shape_1.generate(ccws=True)
shape_1.mesh()
shape_1.generate_image(plot_pts=True)
